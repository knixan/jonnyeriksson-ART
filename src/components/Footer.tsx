        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.facebook.com/profile.php?id=100008406369330" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors flex items-center space-x-2">
                {/* Facebook-ikon */}
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
